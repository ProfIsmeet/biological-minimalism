...
SPLIT_PATH = REPO_ROOT / "results" / "galaxyppg_split_stage3_corrected_eligibility.json"
OUT_PATH = REPO_ROOT / "results" / "galaxyppg_hr_corrected_eligibility_stage3.json"
...
def main() -> None:
    ...
    for seed in SEEDS:
        ...
        for name, model in (("A_cap", model_a), ("B", model_b), ("C", model_c)):
            ckpt_path = CKPT_DIR / f"galaxyppg_hr_corrected_{name}_seed{seed}.pt"
