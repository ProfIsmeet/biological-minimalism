...
# Day-7 integration: union of the integration-branch robustness-resolution
# machinery and the ML-branch scientific additions (capacity-matched PPG
# control, PTT sensitivity, Sleep-EDF EEG+EOG). Multi-target methodology.
