...
def test_robustness_artifact_still_absent_not_fabricated():
    assert not FAULT_ROBUSTNESS_PATH.exists(), (
        "results/ppg_dalia_fault_robustness.json should not have been created by Day 6 work - "
        "it remains a documented gap (see docs/SENSOR_MARGINAL_VALUE_METHODOLOGY.md Appendix A)"
    )
